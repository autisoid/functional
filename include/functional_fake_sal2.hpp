 ...
 * functional_fake_sal2.hpp - There we define rather useless macros as SAL2
 */

#ifdef FUNCTIONAL_FAKE_SAL2_HPP_RECURSE_GUARD
#error Recursive header files inclusion detected in functional_config.hpp
#else //FUNCTIONAL_FAKE_SAL2_HPP_RECURSE_GUARD

#define FUNCTIONAL_FAKE_SAL2_HPP_RECURSE_GUARD

#ifndef FUNCTIONAL_FAKE_SAL2_HPP_GUARD
#define FUNCTIONAL_FAKE_SAL2_HPP_GUARD
#pragma once
